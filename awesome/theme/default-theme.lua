...
theme.font_bold = 'Poppins Bold 10'
...
local awesome_overrides = function(theme)
	...
	-- Menu
	theme.menu_font = 'Poppins Regular 11'
	theme.menu_submenu = '' -- ➤
	...
	theme.taglist_bg_focus = '#666666' .. '99' --theme.background
	theme.taglist_spacing = dpi(0)

	-- Tasklist
	theme.tasklist_font = 'Poppins Regular 10'
	...
	-- Hotkey popup
	theme.hotkeys_font = 'Poppins Bold'
	theme.hotkeys_description_font   = 'Poppins Regular'
